...
public class MPConstants {
    ...
    public static final String DEBUG_TAG = "MusicPlayer_debug";
    public static final String GITHUB_REPO_URL = "https://github.com/tgv293/63CLC2-MobiDev/tree/main/MusicPlayer";
