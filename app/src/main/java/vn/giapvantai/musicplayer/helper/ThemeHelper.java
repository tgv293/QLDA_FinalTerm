...
public class ThemeHelper {
    ...
    /**
     * Lấy danh sách ánh xạ màu và theme tương ứng.
     *
     * @return Danh sách ánh xạ màu và theme
     */
    ...
    /**
     * Lấy theme tương ứng với màu chủ đạo.
     *
     * @param accentColor Màu chủ đạo
     * @return Theme tương ứng
     */
    ...
    /**
     * Áp dụng cài đặt và chuyển đến MainActivity.
     *
    ...
    /**
     * Giải quyết giá trị màu từ thuộc tính của theme.
     *
     * @param context Context hiện tại
     * @param attr    Thuộc tính của theme
    ...
    /**
     * Giải quyết giá trị của thuộc tính từ theme.
     *
     * @param context Context hiện tại
     * @param attr    Thuộc tính của theme
