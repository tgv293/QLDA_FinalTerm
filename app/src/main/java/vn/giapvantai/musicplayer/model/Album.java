...
public class Album implements Parcelable {
    ...
    public List<vn.giapvantai.musicplayer.model.Music> music;
     ...
     */
    public Album(String artist, String title, String year, Long duration, List<vn.giapvantai.musicplayer.model.Music> music) {
    ...
    protected Album(Parcel in) {
        ...
        music = new ArrayList<>();
        in.readTypedList(music, vn.giapvantai.musicplayer.model.Music.CREATOR);
